...
const buildImage = (imgData) => {
  let scrset = `${imgData.urls.full} ${imgData.width}w`;
  if (imgData.urls.regular) {
    scrset = scrset + `,${imgData.urls.regular} 1080w`;
  }
  if (imgData.urls.small) {
    scrset = scrset + `,${imgData.urls.small} 400w`;
  }
    ...
    <figure class="image">
      ...
      <figcaption class="image__caption">
        ...
        <div class="image__meta">
          ...
          <p>
            Uploaded on
            <time class="image__date1" datetime="${imgData.created_at}">
            ${getDate(ImageData)}
            </time>.
          </p>
          <p>
